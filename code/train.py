...
def main():
    ...
    if args.use_cls:
        train_labeled_set, train_unlabeled_set, val_set, test_set, n_labels = get_data_cls(
    ...
    model = MixText(n_labels, args.mix_option, args.use_cls).cuda()
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc >= best_acc:
            ...
            print("epoch {}, test acc {},test loss {}, test f1{} test recall {} test precis {}".format(
