...
def main():
    ...
    in_distribution_test_loader = Data.DataLoader(
        dataset=in_distribution_test_set, batch_size=512, shuffle=False)
...
def test_all_set(testloader, model):
    ...
    with torch.no_grad():
        ...
        print("The target list is {}".format(target_list))
        print("The pred_1 is {}".format(pred_tune_list))
        print("The confidence score is {}".format(pred_score_list))
