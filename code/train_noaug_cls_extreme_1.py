...
from read_data_cls import get_data_cls, get_data_cls_tune, get_data_cls_extreme_tune
...
def main():
    ...
    train_labeled_set, train_unlabeled_set, val_set, test_set, in_distribution_test_set, n_labels, in_distribution_n_labels, encoder, classifier, index_select, out_distribution_test_set, test_set_tune, val_set_tune = get_data_cls_extreme_tune(
