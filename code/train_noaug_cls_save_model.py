...
def main():
    ...
    if args.is_cls:
        train_labeled_set, train_unlabeled_set, val_set, test_set, in_distribution_test_set, n_labels, in_distribution_n_labels = get_data_cls(
            args.data_path, args.n_labeled, args.un_labeled, model=args.model, train_aug=True, seed=args.seed, cls=args.cls)
    else:
    ...
    torch.save(best_state_dict, args.data_path + 'model_{}_n_labels_{}.pt'.format(data_set_name, args.n_labeled))
