#!/bin/bash
#SBATCH -J bertdb10                # 作业名为 test
#SBATCH -o bert_db_10_seed1_in.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python ./code/normal_train.py --gpu 0,1 --n-labeled 10 --data-path ./data/dbpedia_csv/ \
