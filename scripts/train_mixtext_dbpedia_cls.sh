...
#SBATCH -o mix_db_50_MSP.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python ./code/train_noaug_cls.py --gpu 0,1,2,3 --n-labeled 50 \
--data-path ./data/dbpedia_csv/ --batch-size 8 --batch-size-u 8 --epochs 90 --val-iteration 1000 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
