...
#SBATCH -o mix_ag_EM_100.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python -u ./code/train_noaug_cls_EM_extreme_model.py --gpu 2,3 --n-labeled 100 \
--data-path ./data/agnews_csv/ --batch-size 4 --batch-size-u 8 --epochs 40 --val-iteration 1000 \
--lambda-u 1 --T 0.3 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --cls LMCL --is-cls True --extreme-path ./data/eurlex/