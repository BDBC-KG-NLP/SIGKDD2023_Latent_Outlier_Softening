...
python -u ./code/train_noaug_cls.py --gpu 0,1,2 --n-labeled 10 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --cls DOC --is-cls True --extreme-path ./data/eurlex/
